...
#define FMT_ASTC_4x4F   VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT
#define FMT_ASTC_5x4F   VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK_EXT
#define FMT_ASTC_5x5F   VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK_EXT
#define FMT_ASTC_6x5F   VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK_EXT
#define FMT_ASTC_6x6F   VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT
#define FMT_ASTC_8x5F   VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK_EXT
#define FMT_ASTC_8x6F   VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK_EXT
#define FMT_ASTC_8x8F   VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK_EXT
#define FMT_ASTC_10x5F  VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK_EXT
#define FMT_ASTC_10x6F  VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK_EXT
#define FMT_ASTC_10x8F  VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK_EXT
#define FMT_ASTC_10x10F VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK_EXT
#define FMT_ASTC_12x10F VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK_EXT
#define FMT_ASTC_12x12F VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK_EXT

#define FMT_ASTC_SFLOAT_BEGIN_RANGE FMT_ASTC_4x4F
#define FMT_ASTC_SFLOAT_END_RANGE   FMT_ASTC_12x12F
constexpr size_t FMT_ASTC_SFLOAT_RANGE_SIZE=FMT_ASTC_SFLOAT_END_RANGE-FMT_ASTC_SFLOAT_BEGIN_RANGE+1;

inline const bool CheckVulkanFormat(const VkFormat format)
{
    if(format> FMT_BEGIN_RANGE              &&format<=FMT_END_RANGE             )return(true);//BEGIN是FMT_UNDEFINED，所以这里是>而不是>=
    if(format>=FMT_YUV_BEGIN_RANGE          &&format<=FMT_YUV_END_RANGE         )return(true);
    if(format>=FMT_PVRTC_BEGIN_RANGE        &&format<=FMT_PVRTC_END_RANGE       )return(true);
    if(format>=FMT_ASTC_SFLOAT_BEGIN_RANGE  &&format<=FMT_ASTC_SFLOAT_END_RANGE )return(true);
